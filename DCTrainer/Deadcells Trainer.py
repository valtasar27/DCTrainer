...
class Trainer:
    ...
    def __init__(self):
        ...
        self.warning = CTkLabel(master=self.mainframe,text="*this cheat is weird, sometimes it works and \n  sometimes it doesn't and crashes the script,\n  use at will.",font=("Century Gothic",12),justify="left")
        self.warning.pack()
        self.warning.place(x=15,y=435)
        ...
        self.pn_switch = CTkSwitch(self.mainframe,text="Max Brutallity*",variable=self.pn_var,command=self.check)
        self.pn_switch.pack()
